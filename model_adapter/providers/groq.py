"""
Groq Provider - 2026 全面升级版
LLaMA-4, LLaMA-3.3, Mixtral, Gemma2 系列模型

文档: https://console.groq.com/docs/models
认证: Bearer Token
特点: 超低延迟推理 (LPU 加速), 免费 1000 次/天
"""
...
class GroqProvider(BaseProvider):
    ...
    supported_models = [
        ...
        "llama-3.3-70b-instruct",          # LLaMA 3.3 Instruct
        # Mixtral 系列
    ...
    # 模型分组
    MODEL_GROUPS = {
        "premium": ["llama-4-scout-17b-16e-instruct", "llama-4-maverick-17b-128e-instruct"],
        "standard": ["llama-3.3-70b-versatile", "llama-3.3-70b-instruct"],
        "fast": ["mixtral-8x7b-32768", "mistral-7b-32k", "gemma2-9b-it"],
        "large": ["gemma2-27b-it"],
    }
    ...
    def _get_default_max_tokens(self, model: str) -> int:
        """获取模型默认最大 token 数"""
        defaults = {
            "llama-4-scout-17b-16e-instruct": 10000,
            "llama-4-maverick-17b-128e-instruct": 10000,
            "llama-3.3-70b-versatile": 32768,
            "llama-3.3-70b-instruct": 32768,
            "mixtral-8x7b-32768": 32768,
            "mistral-7b-32k": 32768,
            "gemma2-9b-it": 8192,
            "gemma2-27b-it": 8192,
        }
    ...
    async def call(
        ...
        **kwargs
        ...
        if model is None:
            model = self.supported_models[0] if self.supported_models else "llama-3.3-70b-versatile"
