"""
Mistral Provider - 2026 全面升级版
Mistral Large, Codestral, Mistral OCR 系列模型

文档: https://docs.mistral.ai/
认证: Bearer Token
特点: Codestral 代码专用模型, OCR 模型
"""
...
class MistralProvider(BaseProvider):
    ...
    supported_models = [
        ...
        # Codestral 系列 (代码专用)
        "codestral-latest",               # Codestral 最新版
        "codestral-2507",                 # Codestral 2507
        # Mistral OCR
    ...
    # 模型分组
    MODEL_GROUPS = {
        "premium": ["mistral-large-latest", "mistral-large-2"],
        "standard": ["mistral-medium-latest", "mistral-nemo"],
        "fast": ["mistral-small-latest"],
        "coding": ["codestral-latest", "codestral-2507"],
    ...
    def _build_payload(
        ...
        **kwargs
        ...
        # random_id (Mistral 特有)
        if kwargs.get("random_id"):
            payload["random_id"] = kwargs["random_id"]
    ...
    def _get_default_max_tokens(self, model: str) -> int:
        ...
        defaults = {
            ...
            "codestral-2507": 128000,
            "mistral-ocr-latest": 1000000,
            "mistral-nemo": 128000,
        }
    ...
    async def _make_request(
        ...
        async with session.post(
            ...
            if response.status != 200:
                ...
                raise Exception(f"Mistral API error: {response.status} - {error_msg}")
    ...
    async def call(
        ...
        **kwargs
        ...
        if model is None:
            model = self.supported_models[0] if self.supported_models else "mistral-large-latest"
